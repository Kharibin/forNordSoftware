...
test('basic error; 0 context', _asyncToGenerator(_regenerator2.default.mark(function _callee() {
  var error, frames;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 6;
          return (0, _.map)((0, _stackFrameParser.parse)(error), 0);

        case 6:
          frames = _context.sent;

          expect(frames).toEqual(JSON.parse(_fs2.default.readFileSync((0, _path.resolve)(__dirname, '../../fixtures/bundle.json')).toString('utf8')));
...
test('default context (3)', _asyncToGenerator(_regenerator2.default.mark(function _callee2() {
  var error, frames;
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          fetch.mockResponseOnce(_fs2.default.readFileSync((0, _path.resolve)(__dirname, '../../fixtures/bundle.js.map')).toString('utf8'));
          _context2.next = 6;
          return (0, _.map)((0, _stackFrameParser.parse)(error));

        case 6:
          frames = _context2.sent;

          expect(frames).toEqual(JSON.parse(_fs2.default.readFileSync((0, _path.resolve)(__dirname, '../../fixtures/bundle-default.json')).toString('utf8')));
...
test('bad comes back same', _asyncToGenerator(_regenerator2.default.mark(function _callee3() {
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          orig = (0, _stackFrameParser.parse)(error);
